...
import { 
  Building, ShoppingCart, CreditCard, Wallet, 
...
export default function TransactionList({ isDuressMode, onAddFraudClaim }: TransactionListProps) {
  ...
  const transactions: Transaction[] = [
    {
      id: '1',
      title: 'Woolworths',
      amount: isDuressMode ? -450.50 : -1450.50,
      date: '2024-03-15',
      time: '14:30:22',
      type: 'DEBIT',
      category: 'Shopping',
      ...
      <div className="space-y-4">
        {transactions.map((transaction) => (
          ...
          >
            ...
            <span className={transaction.amount > 0 ? 'text-green-600' : 'text-gray-800'}>
